...
namespace Login; // SUPER important for Doctrine othervise can not find the Entities

return array(
	'controllers' => array(
        'invokables' => array(
            'Login\Controller\User' => 'Login\Controller\UserController',
           'Login\Controller\Registration' => 'Login\Controller\RegistrationController',
    ...
    'doctrine' => array(
        ...
        'authentication' => array( // this part is for the Auth adapter from DoctrineModule/Authentication
            'orm_default' => array(
                ...
                'identity_class' => 'Login\Entity\Users', //'Application\Entity\Users',
                'identity_property' => 'usrName', // 'username', // 'email',
                'credential_property' => 'usrPassword', // 'password',
                'credential_callable' => function(Entity\Users $user, $passwordGiven) { // not only User
...
//            'my_annotation_driver' => array(
			__NAMESPACE__ . '_driver' => array(
                ...
                'paths' => array(
					...
					__DIR__ . '/../../Admin/src/Admin/Entity', // Stoyan added to use doctrine in Auth module
                    // 'another/path'
                ),
            ),
            ...
            'orm_default' => array(
                'drivers' => array(
					...
					'Admin\Entity' => __NAMESPACE__ . '_driver' // Stoyan added to allow the module Auth also to use Doctrine
                )
            )
        )
    ),
